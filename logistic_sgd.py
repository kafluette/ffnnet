...
def build_ffnet(input,d,H,PI,rng):
        ...
        id = numpy.identity(d)  # generated by shuffling the columns of the dxd identity matrix
...
#        phi_exp = phi_exp % (2*numpy.pi)
        ...
        return (phi,B,G,S)
>>>>>>> abb71a5077ff17135d0de73eebf5b3e33700303b
...
=======
    def __init__(self, input, n_in, n_out,PI=None,H=None):
>>>>>>> abb71a5077ff17135d0de73eebf5b3e33700303b
...
#            ),
	...
	if old_method:
		...
		pre_softmax = theano.tensor.nnet.sigmoid(T.dot(T.transpose(phi), W) + b)
	if print_on:
...
=======
	if old_method:
        	...
        	self.params = [self.W, self.b, self.G, self.B, self.S]
>>>>>>> abb71a5077ff17135d0de73eebf5b3e33700303b
